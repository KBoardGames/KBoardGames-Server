...
/******************************
 * a list of bad words. These words are checked when typing in text at chat or when logging in to server. If the text to be checked match one of these word then that text will be displayed in *** text at chatter or if logging in the server that username will be rejected.
